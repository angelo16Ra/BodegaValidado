...
namespace Business
{
    public class AuthBusiness : IAuthBusiness
    {
        ...
        public LoginResponse Login(RequestLogin request)
        {
            ...
            result.Persona.Celular = usuario.Celular;
            result.Persona.NumeroDocumento = usuario.NumeroDocumento;
            result.Persona.Correo = usuario.Correo;
            result.Persona.Nombre = usuario.NombrePersona;
            result.Persona.ApMaterno = usuario.ApPaterno;
            result.Persona.ApMaterno = usuario.ApMaterno;
            result.Persona.FechaNacimiento = usuario.FechaNacimiento;
